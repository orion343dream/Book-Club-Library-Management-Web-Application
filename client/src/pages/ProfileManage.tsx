    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <input
            ...
            className={`w-full ${
                Icon ? "pl-12" : "pl-4"
            } pr-4 py-3 rounded-xl bg-white/5 backdrop-blur-sm border-2 transition-all duration-300 text-white placeholder-purple-400/70 focus:outline-none focus:scale-[1.02] shadow-lg ${
                error
        ...
        />
        {error && (
            <X className="absolute right-3 top-1/2 transform -translate-y-1/2 text-red-400 w-5 h-5" />
        )}
        {success && (
  ...
  return (
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          {error && (
              <X className="absolute right-10 top-1/2 transform -translate-y-1/2 text-red-400 w-5 h-5" />
          )}
          {success && (
...
const ProfileManage: React.FC = () => {
  ...
  if (loading) {
    return (
        <div className="min-h-screen bg-gradient-to-tr from-indigo-900 via-blue-900 to-purple-900 flex items-center justify-center">
  ...
  return (
      <div className="min-h-screen bg-gradient-to-tr from-indigo-900 via-blue-900 to-purple-900 py-12 px-6">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="text-center mb-12">
            <h1 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-white via-purple-300 to-indigo-400 bg-clip-text text-transparent mb-4">
              Profile Management
            </h1>
                ...
                <PasswordInput
                    ...
                    onChange={(e) => {
                      ...
                      if (
                          ...
                          e.target.value === passwords.confirmPassword
                      ) {
                        setPasswordErrors((prev) => ({
                          ...prev,
                          confirmPassword: "",
